                          ...
                          <td class="fw-bold">
                            <div class="col-12">
                              <button style="    background-color: #ffc107;
                                ...
                                type="submit"> <a href="suasl.php?ID=<?php echo $row['ID']; ?>"><i class="bi bi-gear"></i></a> </button>
                            </div>
                            <div class="col-12">
                              <button style="      width: 30%!important;
                                ...
                                class="btn btn-primary w-100" type="submit"> <a
                                  href="xoasl.php?ID=<?php echo $row['ID']; ?>"><i class="bi bi-trash"></i></a> </button>
                            </div>
                          </td>
