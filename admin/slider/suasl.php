          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="form-group">
                  ...
                  <input class="form-control-file form-control height-auto" type="file" id="formFile" name="anh" value="<?php echo $row['anh']; ?>">
                </div>
                <div class="col-md-12">
                ...
                <div class="text-center">
                  <button type="submit" value="update" name="suasp" class="btn btn-primary">Cập Nhật</button>
