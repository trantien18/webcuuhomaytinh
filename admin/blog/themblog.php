              ...
              <div class="card-body">
                ...
                <form action="them.php" method="POST" class="row g-3">
                 <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input type="Tieude" name="Tieude" class="form-control" placeholder="Tiêu đề">
                  </div>
                  <div class="col-12">
                    <input type="Noidung" name="Noidung" class="form-control" placeholder="Nội dung">
                  </div>
                  
                  <div class="text-center">
                    <button  type="submit" class="btn btn-primary">Thêm</button>
                    <button type="reset" class="btn btn-secondary"><a href=quanlyblog.php>Quay lại</a></button>
                  </div>
