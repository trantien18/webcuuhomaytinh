...
<?php
    require '../../connect.php';
    $query=mysqli_query($conn,"select * from  adminmenu");
                      ...
                      <tr>
                        ...
                        <th scope="col">Chức Năng</th>
                         ...
                         <button  style="width: 15%!important;
                             float: right;" class="btn btn-primary w-100"><a style="color: #fff;" href="themblog.php">Thêm</a>   </button>
                          </div>
                      </tr>
                    </thead>
                     <?php
              ...
              ?>
                    <tbody>
                      <tr>
                        ...
                        <td><a href="#" class="text-primary fw-bold"><?php echo $row['Tieude'] ?></a></td>
                        <td><?php echo $row['Noidung'] ?>đ</td>
                        <td class="fw-bold">
                           <div class="col-12">
                              <button style="    background-color: #ffc107;
                                                      width: 100%!important;
                                                  --bs-btn-border-color: #fff;
                                                  --bs-btn-hover-color: #fff;" class="btn btn-primary w-100" type="submit"> <a href="sua.php?id=<?php echo $row['ID'];?>"  >Sửa</a> </button>
                            </div>
                            <div class="col-12">
                              <button style="      width: 100%!important;
                                                background-color: #dc3545;
                                              --bs-btn-border-color: #fff;
                                              --bs-btn-hover-color: #fff;"onclick="return confirm('Bạn có muốn xoá thông tin này không ?');" class="btn btn-primary w-100" type="submit"> <a href="xoa.php?id=<?php echo $row['ID'];?>">Xóa</a>  </button>
                            </div>
                        </td>
