              ...
              <table class="table table-borderless">
                <thead>
                  <tr>
                    ...
                    <div class="col-12">
                      <button style="width: 10%!important;
                             float: right;" class="btn btn-primary w-100"><a style="color: #fff;"
                          href="themmenu.php">Thêm</a> </button>
                    </div>
                  </tr>
                </thead>
                <?php
                      ...
                      <td class="fw-bold">
                        <div class="col-12">
                          <button style="    background-color: #ffc107;
                            ...
                            type="submit"> <a href="suamn.php?MenuItemID=<?php echo $row['MenuItemID']; ?>"><i class="bi bi-gear"></i></a>
                          </button>
                        </div>
                        <div class="col-12">
                          <button style="      width: 30%!important;
                            ...
                            class="btn btn-primary w-100" type="submit"> <a
                              href="xoamn.php?MenuItemID=<?php echo $row['MenuItemID']; ?>"><i class="bi bi-trash"></i></a> </button>
                        </div>
                      </td>
                    </tr>
                  </tbody>
