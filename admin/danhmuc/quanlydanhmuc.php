                        ...
                        <div class="col-12">
                          <button style="width: 15%!important;
                             float: right;" class="btn btn-primary w-100"><a style="color: #fff;"
                              href="themdanhmuc.php">Thêm</a> </button>
                        </div>
                      </tr>
                    </thead>
                    <?php
                          ...
                          <td class="fw-bold">
                            <div class="col-12">
                              <button style="    background-color: #ffc107;
                                ...
                                type="submit"> <a href="suadm.php?ID=<?php echo $row['ID']; ?>"><i class="bi bi-gear"></i></a> </button>
                            </div>
                            <div class="col-12">
                              <button style="      width: 50%!important;
                                ...
                                class="btn btn-primary w-100" type="submit"> <a
                                  href="xoadm.php?ID=<?php echo $row['ID']; ?>"><i class="bi bi-trash"></i></a> </button>
                            </div>
                          </td>
